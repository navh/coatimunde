...
It is easy to print a stream of values to be verified as the robot is moving along to ensure they make sense. 
Also the robot return values even when not being driven it is possible to turn both the TurtleBot and the AscTec Pelican by hand and observe what values the odometry reports back.
