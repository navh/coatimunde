...
\secton{Discussion}
	...
	- build a table with some of the requirements and add the field if we ratified them or not (can add an extra comment section for little notes on if we partially met them or something)
