...
\section{Introduction}
	...
	%%%Givigi: I am not sure if this explains the scope of the project. Do you have an example given by the PMO?
	
	%%%I believe we need to basically just re-write this whole section by hand. We should also discuss our rough plan here mwhere we discuss implementing the robot on the ground first and then in the air after this has been proven.
